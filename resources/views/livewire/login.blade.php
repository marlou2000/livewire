<div class="flex items-center justify-center h-screen">
  <div class="w-full max-w-xs">
    ...
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" wire:submit="verifyCredential">
      ...
      <span class="inline-block align-baseline text-sm mt-5">Doesn't have an accout?
        <a class="font-bold text-blue-500 hover:text-blue-800" href="/register">
          Create account
        </a>
      </span>
    </form>
